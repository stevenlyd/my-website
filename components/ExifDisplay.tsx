...
const addressLength = (location: location): number => {
  const length =
    (location?.placeName ?? '').length + (location?.city ?? '').length;
  return length;
};
        ...
        >
          ...
          >
            ...
            >
              ...
              <span>
                <p style={{ margin: '0px 0px 0px 16px' }}>
                  f/{Number(exif.FNumber).toFixed(1)}
                </p>
              </span>
              <span>
                <p style={{ margin: '0px 0px 0px 16px' }}>
                  {Number(exif.ExposureTime) >= 1
                    ? Number(exif.ExposureTime)
                    : `1/${1 / Number(exif.ExposureTime)}`}
                  s
                </p>
              </span>
            </ListItem>
